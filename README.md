...
Получить его можно через интерфейс ioBroker, через редактирование объекта: <span><img src="docs/images/full_id_get_how_ru.png"></span>, нажав на соответствующую кнопку, и потом скопировав строку c идентификатором: <span><img src="docs/images/full_id_get_ru.png"></span>.
